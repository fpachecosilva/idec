...
<html>
	...
	<body class="Tarifa Questionario Questionario6">
        ...
        <section class="Sessao1">
            ...
            <article class="nivel2">    
                ...
                <div class="Sliders">
                    <div class="content">                        
                        <div id="slider-tarifa6"></div>
                        <div id="slider-tarifa6-dir"></div>
                        <label for="amount" class="price"></label>
                    </div>
                </div>

                <p class="Desc">
                   <span>6.</span> Você costuma lavar ou passar roupas à noite?
                </p>
                ...
                <div class="BtnWrapper">
                    <a class="Btn Btn-Small Btn-Destaque4" href="<? echo $Tarifa_Questionario5 ?>">Voltar</a>
                    <a class="Btn Btn-Small Btn-Destaque3" href="<? echo $Tarifa_Questionario_Resultado1 ?>">Próximo</a>
                </div>
