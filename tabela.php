...
<html>
    <head>	
		<?php 
			...
			$tituloPagina = 'Tabela Comparativa - '. $empresa;		
		?>
	...
	<body class="Tabela">
        ...
        <article class="nivel2">
            ...
            <table>
                ...
                <tr>
                    <td>Insira o preço:</td>
                    <form action="">
                        <td>
                            <input type="text" name="" id="" placeholder="R$00,00" onfocus="this.placeholder = ''">
                        </td>
                        <td>
                            <input type="text" name="" id="" placeholder="R$00,00" onfocus="this.placeholder = ''">
                        </td>
            ...
            <a href="<? echo $Eqp_TabelaRes ?>" class="Btn Btn-Destaque1 Btn-Default">Qual o mais vantajoso?</a>
