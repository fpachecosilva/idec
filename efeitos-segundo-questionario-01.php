...
<html>
	...
	<body class="Efeitos Questionario SegQuestionario SegQuestionario1">
        ...
        <section class="Sessao1">
            ...
            <article class="nivel2">    
                ...
                <div class="WrapperButtons">
                    <a class="Btn Btn-Small Btn-Destaque4" href="<? echo $Efeitos_Questionario_Resultado ?>">Voltar</a>
                    <a class="Btn Btn-Small Btn-Destaque2" href="<? echo $Efeitos_Segundo_Questionario2 ?>">Próximo</a>
                </div>
